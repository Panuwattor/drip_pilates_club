      ...
      <div class="man-body">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td>ลูกค้า walk-in มาเรียนสด ไม่ได้จอง</td><td><b>เคาน์เตอร์</b> → ค้นชื่อ → หักเครดิต</td></tr>
  ...
  <section class="man-sec" id="counter">
    <div class="card-panel">
      ...
      <div class="man-body">
        ...
        <h3>หักเครดิต</h3>
        <p>ใช้เมื่อลูกค้าใช้สิทธิ์ไปแล้วแต่ไม่ได้ผ่านการจองในระบบ เลือกเหตุผลสำเร็จรูป ใส่จำนวน แล้วกด</p>
        <ul>
          <li><b>ลูกค้า walk-in มาเรียนสด</b> — เดินเข้ามาเรียนเลย ไม่ได้จองล่วงหน้า</li>
          <li><b>หักค่าคลาสที่เรียนไปแล้ว</b> — เรียนไปแล้วแต่ลืมบันทึกในระบบ</li>
